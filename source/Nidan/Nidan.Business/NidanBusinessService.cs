...
namespace Nidan.Business
{
    public partial class NidanBusinessService : INidanBusinessService, ITenantOrganisationService
    {
        ...
        public Event CreateEvent(int organisationId, Event eventplan)
        {
            ...
            var data = _nidanDataService.CreateEvent(organisationId, eventplan);
            ...
            CandidateFee candidateFee)
        {
            ...
            var candidateFeeData = new CandidateFee
            {
                ...
                PaidAmount = candidateInstallment.LumpsumAmount - totalRegistrationAmount,
            ...
            CandidateFee candidateFee)
        {
            ...
            var candidateFeeData = new CandidateFee
            {
                ...
                IsPaymentDone = true,
                StudentCode = admission.Registration.StudentCode,
                PaidAmount = candidateFee.IsPaidAmountOverride ? candidateFee.PaidAmount : candidateInstallment.DownPayment <= totalRegistrationAmount
                    ? 0
                    : (candidateInstallment.DownPayment - totalRegistrationAmount),
                PaymentDate = DateTime.UtcNow,
                ReceiptNumber = receiptNumber
            };
            // Increment RecieptNo by and Update.
        ...
        {
            return _nidanDataService.RetrieveEventQuestion(organisationId, eventQuestionId, predicate);
        }
        ...
        {
            return _nidanDataService.RetrieveEventQuestions(organisationId, predicate, orderBy, paging);
        }
        ...
        {
            return _nidanDataService.RetrieveEventManagement(organisationId, eventManagementId, predicate);
        }
        ...
        public PagedResult<CandidateFinalPlacement> RetrieveCandidateFinalPlacements(int organisationId, Expression<Func<CandidateFinalPlacement, bool>> predicate, List<OrderBy> orderBy = null,
            Paging paging = null)
        {
            return _nidanDataService.RetrieveCandidateFinalPlacements(organisationId, predicate, orderBy, paging);
        }

        public PagedResult<CandidatePrePlacementActivityGrid> RetrieveCandidatePrePlacementActivityBySearchKeyword(int organisationId, string searchKeyword,
        ...
        public bool UpdateEventManagement(int organisationId, int centreId, int personnelId, int eventId, List<EventManagement> eventManagement)
        {
            return _nidanDataService.UpdateEventManagement(organisationId, centreId, personnelId, eventId, eventManagement);
        }
