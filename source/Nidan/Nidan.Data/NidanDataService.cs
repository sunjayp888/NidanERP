...
namespace Nidan.Data
{
    public partial class NidanDataService : INidanDataService
    {
        ...
        public EventManagement CreateEventManagement(int organisationId, EventManagement eventManagement)
        {
            using (var context = _databaseFactory.Create(organisationId))
            {
                eventManagement = context.EventManagements.Add(eventManagement);
                context.SaveChanges();
            ...
            CandidatePrePlacementReport candidatePrePlacementReport)
        {
            using (var context = _databaseFactory.Create(organisationId))
            {
                candidatePrePlacementReport = context.CandidatePrePlacementReports.Add(candidatePrePlacementReport);
                context.SaveChanges();

                return candidatePrePlacementReport;
            }
        }
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    ...
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
                        new OrderBy
                        {
                            Property = "ModuleExamQuestionSetId",
                            Direction = System.ComponentModel.ListSortDirection.Ascending
                        }
                    })
                    .Paginate(paging);
        ...
        public Partner RetrievePartner(int organisationId, int partnerId, Expression<Func<Partner, bool>> predicate)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    ...
                    .AsNoTracking()
                    .Where(predicate)
                    .SingleOrDefault(p => p.PartnerId == partnerId);
            }
        }
        ...
        public EventQuestion RetrieveEventQuestion(int organisationId, int eventQuestionId, Expression<Func<EventQuestion, bool>> predicate)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    ...
                    .AsNoTracking()
                    .Where(predicate)
                    .SingleOrDefault(p => p.EventQuestionId == eventQuestionId);
            }
        }

        public PagedResult<EventQuestion> RetrieveEventQuestions(int organisationId, Expression<Func<EventQuestion, bool>> predicate, List<OrderBy> orderBy = null, Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
        ...
        public EventManagement RetrieveEventManagement(int organisationId, int eventManagementId, Expression<Func<EventManagement, bool>> predicate)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    ...
                    .AsNoTracking()
                    .Where(predicate)
                    .SingleOrDefault(p => p.EventManagementId == eventManagementId);
            }
        }

        public PagedResult<EventManagement> RetrieveEventManagements(int organisationId, Expression<Func<EventManagement, bool>> predicate, List<OrderBy> orderBy = null,
            Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
        ...
        public PagedResult<CandidatePostPlacementGrid> RetrieveCandidatePostPlacementBySearchKeyword(int organisationId, string searchKeyword,
            Expression<Func<CandidatePostPlacementGrid, bool>> predicate, List<OrderBy> orderBy = null, Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                var searchData = context.Database
                    .SqlQuery<CandidatePostPlacementGrid>("SearchCandidatePostPlacement @SearchKeyword", category).ToList();
        ...
        public PagedResult<CandidateFinalPlacementGrid> RetrieveCandidateFinalPlacementBySearchKeyword(int organisationId, string searchKeyword,
            Expression<Func<CandidateFinalPlacementGrid, bool>> predicate, List<OrderBy> orderBy = null, Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                var searchData = context.Database
                    .SqlQuery<CandidateFinalPlacementGrid>("SearchCandidateFinalPlacement @SearchKeyword", category).ToList();
                ...
                var data = searchData.ToList().AsQueryable()
                    ...
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
                        new OrderBy
                        {
                            Property = "CandidateFinalPlacementId",
                            Direction = System.ComponentModel.ListSortDirection.Ascending
                        }
                    })
                    .Paginate(paging);
        ...
        public PagedResult<CandidateFinalPlacement> RetrieveCandidateFinalPlacements(int organisationId, Expression<Func<CandidateFinalPlacement, bool>> predicate, List<OrderBy> orderBy = null,
            Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
        ...
        public PagedResult<CandidatePrePlacementActivityGrid> RetrieveCandidatePrePlacementActivityBySearchKeyword(int organisationId, string searchKeyword, Expression<Func<CandidatePrePlacementActivityGrid, bool>> predicate, List<OrderBy> orderBy = null, Paging paging = null)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                var searchData = context.Database
                    .SqlQuery<CandidatePrePlacementActivityGrid>("SearchCandidatePrePlacementActivity @SearchKeyword", category).ToList();
                ...
                var data = searchData.ToList().AsQueryable()
                    ...
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
                        new OrderBy
                        {
                            Property = "CandidatePrePlacementId",
                            Direction = System.ComponentModel.ListSortDirection.Ascending
                        }
                    })
                    .Paginate(paging);
            ...
            List<OrderBy> orderBy = null, Paging paging = null)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                var searchData = context.Database
                    .SqlQuery<BatchPrePlacementSearchField>("SearchBatchPrePlacement @SearchKeyword", category).ToList();
        ...
        public CandidatePrePlacement RetrieveCandidatePrePlacement(int organisationId, int candidatePrePlacementId)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    .CandidatePrePlacements
                    .AsNoTracking()
                    .SingleOrDefault(p => p.CandidatePrePlacementId == candidatePrePlacementId);
            }
        }

        public PagedResult<PrePlacementActivity> RetrievePrePlacementActivities(int organisationId, Expression<Func<PrePlacementActivity, bool>> predicate, List<OrderBy> orderBy = null,
            Paging paging = null)
        {
            using (ReadUncommitedTransactionScope)
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                return context
                    ...
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
                        new OrderBy
                        {
                            Property = "PrePlacementActivityId",
                            Direction = System.ComponentModel.ListSortDirection.Ascending
                        }
                    })
                    .Paginate(paging);
        ...
        public CandidatePrePlacementReport RetrieveCandidatePrePlacementReport(int organisationId, int candidatePrePlacementReportId)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                return context
                    ...
                    .AsNoTracking()
                    .SingleOrDefault(p => p.CandidatePrePlacementReportId == candidatePrePlacementReportId);
            }
        }
            ...
            Paging paging = null)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                return context
                    .CandidatePrePlacementReportGrids
                    .AsNoTracking()
                    .Where(predicate)
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
            ...
            Paging paging = null)
        {
            ...
            using (var context = _databaseFactory.Create(organisationId))
            {
                ...
                return context
                    .CandidatePrePlacementDataGrids
                    .AsNoTracking()
                    .Where(predicate)
                    .OrderBy(orderBy ?? new List<OrderBy>
                    {
